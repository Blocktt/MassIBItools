...
1. Load file
    ...
    + Once uploaded, make sure data is correct in the viewer. If the incorrect Separator or Quote is chosen, you may receive an error (Fig. 5) or the data may look incorrect in the viewer. 
